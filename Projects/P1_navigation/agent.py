from model import My_DeepQ_Network
import torch
...
class Agent:
    def __init__(self, state_size, action_size, seed):
        ...
        self.dqn_local = My_DeepQ_Network(state_size, action_size, seed).to(device)
        self.dqn_target = My_DeepQ_Network(state_size, action_size, seed).to(device)
